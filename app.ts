...
const DEMO_GAME: Game = {
  version: 1,
  gameId: "game_demo_2026",
  title: "Demo Game Night",
  createdAt: "2024-08-20T19:00:00.000Z",
  finalizedAt: "2024-08-20T19:30:00.000Z",
  players: [
    { id: "p_laure", name: "Laure" },
    { id: "p_katy", name: "Katy" },
    { id: "p_roy", name: "Roy" },
    { id: "p_koen", name: "Koen" },
    { id: "p_marieke", name: "Marieke" },
    { id: "p_audrey", name: "Audrey" },
  ],
  questions: [
    { id: "q1", text: "Most likely to start a dance party", presenterId: "p_laure" },
    { id: "q2", text: "Best snack curator", presenterId: "p_katy" },
    { id: "q3", text: "Most likely to survive a zombie apocalypse", presenterId: "p_roy" },
    { id: "q4", text: "Worst at replying to group chats", presenterId: "p_koen" },
    { id: "q5", text: "Secretly the biggest softie", presenterId: "p_marieke" },
  ],
  submissions: {
    p_laure: {
      version: 1,
      ...
      byQuestion: {
        q1: ["p_audrey", "p_roy", "p_katy", "p_laure", "p_marieke", "p_koen"],
        q2: ["p_marieke", "p_laure", "p_roy", "p_katy", "p_audrey", "p_koen"],
        q3: ["p_koen", "p_marieke", "p_katy", "p_roy", "p_audrey", "p_laure"],
        q4: ["p_katy", "p_koen", "p_audrey", "p_roy", "p_laure", "p_marieke"],
        q5: ["p_roy", "p_marieke", "p_laure", "p_audrey", "p_katy", "p_koen"],
      },
    },
    p_katy: {
      version: 1,
      ...
      byQuestion: {
        q1: ["p_roy", "p_audrey", "p_katy", "p_marieke", "p_koen", "p_laure"],
        q2: ["p_marieke", "p_roy", "p_katy", "p_audrey", "p_laure", "p_koen"],
        q3: ["p_koen", "p_katy", "p_marieke", "p_roy", "p_audrey", "p_laure"],
        q4: ["p_katy", "p_koen", "p_audrey", "p_roy", "p_marieke", "p_laure"],
        q5: ["p_roy", "p_marieke", "p_audrey", "p_laure", "p_katy", "p_koen"],
      },
    },
    p_roy: {
      version: 1,
      ...
      byQuestion: {
        q1: ["p_audrey", "p_katy", "p_roy", "p_marieke", "p_laure", "p_koen"],
        q2: ["p_marieke", "p_roy", "p_audrey", "p_laure", "p_katy", "p_koen"],
        q3: ["p_koen", "p_marieke", "p_roy", "p_katy", "p_audrey", "p_laure"],
        q4: ["p_koen", "p_katy", "p_audrey", "p_roy", "p_marieke", "p_laure"],
        q5: ["p_roy", "p_marieke", "p_audrey", "p_laure", "p_katy", "p_koen"],
      },
    },
    p_koen: {
      ...
      byQuestion: {
        q1: ["p_audrey", "p_roy", "p_marieke", "p_katy", "p_koen", "p_laure"],
        q2: ["p_marieke", "p_audrey", "p_roy", "p_katy", "p_laure", "p_koen"],
        q3: ["p_koen", "p_marieke", "p_katy", "p_roy", "p_audrey", "p_laure"],
        q4: ["p_koen", "p_katy", "p_audrey", "p_marieke", "p_roy", "p_laure"],
        q5: ["p_marieke", "p_roy", "p_audrey", "p_laure", "p_katy", "p_koen"],
      },
    },
    p_marieke: {
      version: 1,
      ...
      byQuestion: {
        q1: ["p_roy", "p_audrey", "p_marieke", "p_katy", "p_laure", "p_koen"],
        q2: ["p_marieke", "p_roy", "p_laure", "p_audrey", "p_katy", "p_koen"],
        q3: ["p_marieke", "p_koen", "p_katy", "p_roy", "p_audrey", "p_laure"],
        q4: ["p_katy", "p_koen", "p_audrey", "p_roy", "p_marieke", "p_laure"],
        q5: ["p_marieke", "p_roy", "p_audrey", "p_laure", "p_katy", "p_koen"],
      },
    },
    p_audrey: {
      ...
      byQuestion: {
        q1: ["p_audrey", "p_roy", "p_katy", "p_marieke", "p_laure", "p_koen"],
        q2: ["p_marieke", "p_roy", "p_audrey", "p_laure", "p_katy", "p_koen"],
        q3: ["p_koen", "p_marieke", "p_katy", "p_audrey", "p_roy", "p_laure"],
        q4: ["p_koen", "p_katy", "p_audrey", "p_marieke", "p_roy", "p_laure"],
        q5: ["p_roy", "p_marieke", "p_audrey", "p_laure", "p_katy", "p_koen"],
      },
    },
